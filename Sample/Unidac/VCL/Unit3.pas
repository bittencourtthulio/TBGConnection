...
uses
  ...
  Vcl.Mask, Vcl.DBCtrls, Vcl.Imaging.jpeg, Vcl.ExtCtrls;
...
begin
  ...
  try
    ...
    TBGQuery4.Query.ParamByName('ID').AsInteger := StrToInt(Edit2.Text);
    TBGQuery4.Query.ParamByName('NOME').AsString := Edit3.Text;

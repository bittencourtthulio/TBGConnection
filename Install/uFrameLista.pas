...
type
  ...
  TframePacotes = class(TFrame)
    ...
    Label8: TLabel;
    Label21: TLabel;
    TBGAbstConnection_dpk: TCheckBox;
    TBGDBExpressDriver_dpk: TCheckBox;
    TBGQuery_dpk: TCheckBox;
    TBGFiredacDriver_dpk: TCheckBox;
    TBGUniDacDriver_dpk: TCheckBox;
    TBGZeosDriver_dpk: TCheckBox;
    TBGRestDWDriver_dpk: TCheckBox;
    Label1: TLabel;
...
begin
  ...
  begin
    ...
    try
      // quando não for selecionado, devemos desmarcar os conectores
      if not TBGAbstConnection_dpk.Checked then
      begin
        TBGQuery_dpk.Checked          := False;
        TBGDBExpressDriver_dpk.Checked:= False;
        TBGFiredacDriver_dpk.Checked  := False;
        TBGUniDacDriver_dpk.Checked   := False;
        TBGZeosDriver_dpk.Checked     := False;
        TBGRestDWDriver_dpk.Checked   := False;
      end;
